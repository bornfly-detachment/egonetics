...
## 10. S — State Instruction

| Field | Values |
|-------|--------|
| `source` | S1_task_driven / S2_survival_driven / S3_evolution_driven / S4_exploration_driven |
| `nodeTier` | execution / research / update |
| `currentState` | building / trial / stable / bug_suspended / waiting / positive_loop / negative_loop / archived |
| `targetState` | same enum |
| `guards` | ValueGates that must all pass |
| `effects` | trigger_perception / trigger_execution / trigger_evolution / trigger_communication |
