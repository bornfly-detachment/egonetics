...
const ProjectCard: React.FC<{
  ...
  const propsSummary = project.propertyDefs.slice(0, 3).map((def: any) => ({
    name: def.name,
...
const CreateProjectModal: React.FC<{
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div className="glass-panel p-8 w-full max-w-md border border-white/10 shadow-2xl" onClick={e => e.stopPropagation()}>
        {/* Header */}
